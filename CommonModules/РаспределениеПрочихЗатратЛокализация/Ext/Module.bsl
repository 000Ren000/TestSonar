...
Процедура УстановитьПризнакиБУиНУ(Объект, ВидУчета, НастройкиРаспределения) Экспорт
	
	УчетПоНДД = РасчетСебестоимостиЛокализация.ПолучитьФункциональнуюОпциюУчетПоНДД();
	
	Если УчетПоНДД Тогда
		Если ВидУчета = "НДД" Тогда
			Если ПроверитьСоответствиеНастроекРеглНалНДД(НастройкиРаспределения) Тогда
				Объект.НалоговыйУчет          = Истина;
				Объект.РегламентированныйУчет = Истина;
			ИначеЕсли ПроверитьСоответствиеНастроекНалНДД(НастройкиРаспределения) Тогда
				Объект.НалоговыйУчет = Истина;
			ИначеЕсли ПроверитьСоответствиеНастроекРеглНДД(НастройкиРаспределения) Тогда
				Объект.РегламентированныйУчет = Истина;
			КонецЕсли;
		ИначеЕсли ВидУчета = "РегламентированныйУчет" ИЛИ ВидУчета = "НалоговыйУчет" Тогда
			Если Объект.НалоговыйУчет = Объект.РегламентированныйУчет Тогда
				Объект.НДД = ПроверитьСоответствиеНастроекРеглНалНДД(НастройкиРаспределения);
			ИначеЕсли Объект.НалоговыйУчет Тогда
				Объект.НДД = ПроверитьСоответствиеНастроекНалНДД(НастройкиРаспределения);
			ИначеЕсли Объект.РегламентированныйУчет Тогда
				Объект.НДД = ПроверитьСоответствиеНастроекРеглНДД(НастройкиРаспределения);
			КонецЕсли;
		КонецЕсли;
	КонецЕсли;
