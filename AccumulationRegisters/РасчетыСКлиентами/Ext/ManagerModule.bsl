...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	Пока ОбновляемыеДанные.Следующий() Цикл
		...
		Попытка
			...
			Если НоваяАрхитектураВзаиморасчетов И НЕ ОчисткаФлагаИсточника И НаборЗаписей.Модифицированность() И НЕ ЕстьОшибка Тогда
